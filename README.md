...
- [Architecture and Algorithm Designs](#architecture-and-algorithm-designs) (76)
...
<!-- AUTO-GENERATED by scripts/build.py on 2026-07-29 03:44 UTC — DO NOT EDIT the lists below manually. Edit papers/*.yaml or blogs/*.yaml and run `python3 scripts/build.py` instead. -->
...
- <details>
  <summary>[07/28/2026] <strong>Penelope: Localized Latent Recurrence for Efficient Structured Reasoning</strong> <a href="https://arxiv.org/abs/2607.25915"><img alt="arXiv" src="https://img.shields.io/badge/arXiv-2607.25915-b31b1b.svg"></a> <a href="https://www.alphaxiv.org/abs/2607.25915"><img alt="AlphaXiv" src="https://img.shields.io/badge/AlphaXiv-2607.25915-7c3aed.svg"></a></summary>
  <div><strong>Authors:</strong> Yutong Chen, Shouqian Shi, Xinran Liu, Haochen Wang, Jiaying Wang, Tianxing Xu, Yuanxi Wang, Zirui Ding · 2026</div>
  <div><strong>Loop Mechanism:</strong> flat-loop</div>
  <div><strong>Focus:</strong> architecture · inference-algorithm · training-algorithm</div>
  <div><strong>Domains:</strong> language-modeling · reasoning · efficiency</div>
  <div><strong>TL;DR:</strong> Localizes latent recurrent computation to a narrow decoder interval, iteratively refining problem-conditioned boundary memory with GRU dynamics and recurrent readout states before answer generation.</div>
  </details>
