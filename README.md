...
- [Theoretical and Mechanical Analysis](#theoretical-and-mechanical-analysis) (17)
- [Architecture and Algorithm Designs](#architecture-and-algorithm-designs) (44)
- [Applications Focused](#applications-focused) (4)
- [Blogs](#blogs) (6)
...
<!-- AUTO-GENERATED by scripts/build.py on 2026-05-12 00:40 UTC — DO NOT EDIT the lists below manually. Edit papers/*.yaml or blogs/*.yaml and run `python3 scripts/build.py` instead. -->
...
- <details>
  ...
  <div><strong>Domains:</strong> language-modeling · reasoning · memory-efficiency · efficiency</div>
  <div><strong>TL;DR:</strong> Introduces MELT, a looped transformer variant that shares a single per-layer KV cache across reasoning loops and updates it with a learnable gate, decoupling loop depth from memory growth for Ouro/LoopLM-style recurrent LLMs.</div>
  </details>
