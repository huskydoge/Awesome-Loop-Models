...
- [Architecture and Algorithm Designs](#architecture-and-algorithm-designs) (47)
...
<!-- AUTO-GENERATED by scripts/build.py on 2026-05-15 03:35 UTC — DO NOT EDIT the lists below manually. Edit papers/*.yaml or blogs/*.yaml and run `python3 scripts/build.py` instead. -->
...
- <details>
  ...
  <div><strong>Loop Mechanism:</strong> flat-loop</div>
  <div><strong>Focus:</strong> architecture · inference-algorithm</div>
  <div><strong>Domains:</strong> wireless-communications · sequence-modeling · efficiency</div>
