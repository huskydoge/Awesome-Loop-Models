...
- [Architecture and Algorithm Designs](#architecture-and-algorithm-designs) (87)
...
<!-- AUTO-GENERATED by scripts/build.py on 2026-08-17 06:51 UTC — DO NOT EDIT the lists below manually. Edit papers/*.yaml or blogs/*.yaml and run `python3 scripts/build.py` instead. -->
...
- <details>
  <summary>[08/14/2026] <strong>Nanbeige4.2-3B on Apple Silicon: Fixing Deployment Bugs and Decreasing Looped Transformer Memory Overhead</strong> <a href="https://arxiv.org/abs/2608.13987"><img alt="arXiv" src="https://img.shields.io/badge/arXiv-2608.13987-b31b1b.svg"></a> <a href="https://www.alphaxiv.org/abs/2608.13987"><img alt="AlphaXiv" src="https://img.shields.io/badge/AlphaXiv-2608.13987-7c3aed.svg"></a></summary>
  <div><strong>Authors:</strong> John T. Halloran · 2026</div>
  ...
  <div><strong>TL;DR:</strong> Analyzes and fixes deployment bottlenecks for a 3B Looped Transformer that sends hidden states through the same layer stack twice, using chunked prefill to extend practical context length on 32 GiB Apple Silicon.</div>
  </details>
...
- <details>
  <summary>[08/13/2026] <strong>DFM Mimir v1: An Open HRM Delivering Frontier Performance at 1B Parameters Using Only Permissible Post-Training Data</strong> <a href="https://arxiv.org/abs/2608.13517"><img alt="arXiv" src="https://img.shields.io/badge/arXiv-2608.13517-b31b1b.svg"></a> <a href="https://www.alphaxiv.org/abs/2608.13517"><img alt="AlphaXiv" src="https://img.shields.io/badge/AlphaXiv-2608.13517-7c3aed.svg"></a> <a href="https://github.com/schneiderkamplab/HRM-Text/stargazers"><img alt="GitHub stars" src="https://img.shields.io/github/stars/schneiderkamplab/HRM-Text?style=social"></a></summary>
  <div><strong>Authors:</strong> Peter Schneider-Kamp, Jacob Nielsen, Gianluca Barmina, Kenneth Enevoldsen, Lukas Galke Poech · 2026</div>
  <div><strong>Loop Mechanism:</strong> hierarchical-loop</div>
  <div><strong>Focus:</strong> architecture · training-algorithm · data</div>
  <div><strong>Domains:</strong> language-modeling · reasoning</div>
  <div><strong>TL;DR:</strong> Trains a 1B Danish-English HRM-Text model from scratch on a permissibility-focused 70.5B-token instruction mixture, reusing fast and slow learned modules over two H-cycles and three L-cycles.</div>
  </details>
