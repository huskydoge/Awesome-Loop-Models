...
<!-- AUTO-GENERATED by scripts/build.py on 2026-05-01 00:25 UTC — DO NOT EDIT the lists below manually. Edit papers/*.yaml or blogs/*.yaml and run `python3 scripts/build.py` instead. -->
...
- <details>
  <summary>[04/01/2026] <strong>Associative-State Universal Transformers: Sparse Retrieval Meets Structured Recurrence</strong> <a href="https://arxiv.org/abs/2604.25930"><img alt="arXiv" src="https://img.shields.io/badge/arXiv-2604.25930-b31b1b.svg"></a> <a href="https://www.alphaxiv.org/abs/2604.25930"><img alt="AlphaXiv" src="https://img.shields.io/badge/AlphaXiv-2604.25930-7c3aed.svg"></a></summary>
  <div><strong>Authors:</strong> Liu Xiao · 2026</div>
  <div><strong>Loop Mechanism:</strong> flat-loop</div>
  <div><strong>Focus:</strong> architecture · inference-algorithm</div>
  <div><strong>Domains:</strong> language-modeling · algorithmic-reasoning · efficiency</div>
  <div><strong>TL;DR:</strong> Introduces UniMatrix, a Universal Transformer-style family that reuses a shared recurrent block across depth and combines compact recurrent state with sparse slot routing and pointer-logit fusion for language modeling and associative recall.</div>
  </details>
