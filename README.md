...
<!-- AUTO-GENERATED by scripts/build.py on 2026-05-04 00:14 UTC — DO NOT EDIT the lists below manually. Edit papers/*.yaml or blogs/*.yaml and run `python3 scripts/build.py` instead. -->
...
- <details>
  ...
  <div><strong>TL;DR:</strong> Introduces an all-MLP time-series forecasting framework whose iterative refinement module repeatedly applies a shared-parameter residual mixer stack, deepening computation without adding distinct parameters.</div>
  </details>
