...
<!-- AUTO-GENERATED by scripts/build.py on 2026-09-17 01:25 UTC — DO NOT EDIT the lists below manually. Edit papers/*.yaml or blogs/*.yaml and run `python3 scripts/build.py` instead. -->
...
<details>
  ...
  <div><strong>Authors:</strong> Jonas Geiping, Xinyu Yang, Guinan Su · ICML 2025</div>
  <div><strong>Loop Mechanism:</strong> flat-loop · parallel-loop</div>
  <div><strong>Focus:</strong> inference-algorithm</div>
  <div><strong>Domains:</strong> language-modeling · reasoning · efficiency</div>
...
<details>
  ...
  <div><strong>Authors:</strong> Zhiqiang Shen, Zechun Liu, Eric Xing · ECCV 2021</div>
  <div><strong>Loop Mechanism:</strong> flat-loop</div>
  <div><strong>Focus:</strong> architecture</div>
  <div><strong>Domains:</strong> vision · efficiency · scaling</div>
...
<details>
  ...
  <div><strong>Authors:</strong> Róbert Csordás, Kazuki Irie, Jürgen Schmidhuber · ICLR 2021</div>
  <div><strong>Loop Mechanism:</strong> flat-loop</div>
  <div><strong>Focus:</strong> architecture</div>
...
<details>
  ...
  <div><strong>Authors:</strong> Sho Takase, Shun Kiyono · SustaiNLP 2021</div>
  <div><strong>Loop Mechanism:</strong> flat-loop</div>
  <div><strong>Focus:</strong> architecture</div>
...
<details>
  ...
  <div><strong>Authors:</strong> Sangho Lee, Youngjae Yu, Gunhee Kim, Thomas Breuel, Jan Kautz, Yale Song · ICLR 2020</div>
  <div><strong>Loop Mechanism:</strong> flat-loop</div>
  <div><strong>Focus:</strong> architecture</div>
...
<details>
  ...
  <div><strong>Authors:</strong> Zhenzhong Lan, Mingda Chen, Sebastian Goodman, Kevin Gimpel, Piyush Sharma, Radu Soricut · ICLR 2019</div>
  <div><strong>Loop Mechanism:</strong> flat-loop</div>
  <div><strong>Focus:</strong> architecture · training-algorithm</div>
  <div><strong>Domains:</strong> language-modeling · efficiency · memory-efficiency</div>
...
<details>
  ...
  <div><strong>Authors:</strong> Laurent El Ghaoui, Fangda Gu, Bertrand Travacca, Armin Askari, Alicia Y. Tsai · SIAM Journal on Mathematics of Data Science 2019</div>
  <div><strong>Loop Mechanism:</strong> implicit-layer</div>
  <div><strong>Focus:</strong> architecture · training-algorithm · inference-algorithm</div>
  <div><strong>Domains:</strong> theory · efficiency</div>
...
<details>
  ...
  <div><strong>Authors:</strong> Shaojie Bai, J. Zico Kolter, Vladlen Koltun · ICLR 2018</div>
  <div><strong>Loop Mechanism:</strong> flat-loop</div>
  <div><strong>Focus:</strong> architecture</div>
...
<details>
  ...
  <div><strong>Authors:</strong> Raj Dabre, Atsushi Fujita · AAAI 2018</div>
  <div><strong>Loop Mechanism:</strong> flat-loop</div>
  <div><strong>Focus:</strong> architecture</div>
...
<details>
  ...
  <div><strong>Authors:</strong> Jiwon Kim, Jung Kwon Lee, Kyoung Mu Lee · CVPR 2015</div>
  <div><strong>Loop Mechanism:</strong> flat-loop</div>
  <div><strong>Focus:</strong> architecture · training-algorithm</div>
  <div><strong>Domains:</strong> vision · efficiency</div>
...
<details>
  ...
  <div><strong>Authors:</strong> Petar Veličković, Rex Ying, Matilde Padovano, Raia Hadsell, Charles Blundell · ICLR 2019</div>
  <div><strong>Loop Mechanism:</strong> flat-loop</div>
  <div><strong>Focus:</strong> architecture · training-algorithm</div>
  <div><strong>Domains:</strong> graph-data · algorithmic-reasoning</div>
