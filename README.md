...
- [Architecture and Algorithm Designs](#architecture-and-algorithm-designs) (64)
...
<!-- AUTO-GENERATED by scripts/build.py on 2026-06-17 00:09 UTC — DO NOT EDIT the lists below manually. Edit papers/*.yaml or blogs/*.yaml and run `python3 scripts/build.py` instead. -->
...
- <details>
  <summary>[06/15/2026] <strong>Tying the Loop -- Tied Expert Layers in Mixture-of-Experts Language Models</strong> <a href="https://arxiv.org/abs/2606.16825"><img alt="arXiv" src="https://img.shields.io/badge/arXiv-2606.16825-b31b1b.svg"></a> <a href="https://www.alphaxiv.org/abs/2606.16825"><img alt="AlphaXiv" src="https://img.shields.io/badge/AlphaXiv-2606.16825-7c3aed.svg"></a> <a href="https://github.com/epfml/looped-moe/stargazers"><img alt="GitHub stars" src="https://img.shields.io/github/stars/epfml/looped-moe?style=social"></a></summary>
  <div><strong>Authors:</strong> Martin Jaggi · 2026</div>
  <div><strong>Loop Mechanism:</strong> flat-loop</div>
  <div><strong>Focus:</strong> architecture</div>
  <div><strong>Domains:</strong> language-modeling · efficiency · scaling</div>
  <div><strong>TL;DR:</strong> Introduces Expert Tying, an MoE language-model architecture that reuses expert parameters across consecutive Transformer layers while keeping independent routing and attention, cutting expert memory by nearly 2x with little perplexity or downstream degradation.</div>
  </details>
